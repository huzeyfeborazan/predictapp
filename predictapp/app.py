...
from predictapp.extensions import debug_toolbar
from predictapp.extensions import flask_static_digest
from predictapp.page.views import page
from predictapp.up.views import up
